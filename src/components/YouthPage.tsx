    ...
    <div className="space-y-4 animate-fadeIn">
      ...
      {activeUser && userSampanaList.length > 0 && (
        <div className="bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800 rounded-2xl p-2.5 shadow-xs flex flex-col gap-1.5 animate-scaleIn">
          <span className="text-[9px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-wider animate-pulse">
            Sokajy Sampana misy anao (Ahodina miankavia/miankavanana raha maromaro) • {userSampanaList.length} voafidy
          </span>
          <div className="flex items-center gap-2 overflow-x-auto whitespace-nowrap py-1 scrollbar-thin scrollbar-thumb-violet-300 dark:scrollbar-thumb-violet-800 w-full">
            {userSampanaList.map((samp) => {
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-2 text-xs font-black rounded-xl cursor-pointer transition-all active:scale-95 shrink-0 ${
                    isSelected
